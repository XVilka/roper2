...
\lstset{language=rust,label=orgea882de,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=rust,label=orgdf1cb10,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=rust,label=orgc8401e6,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#[test]
...
\label{sec:org4a428a0}
\subsection{General Registers for the Architectures Supported}
\label{sec:orgf62d70c}

\lstset{language=rust,label=org71b0a8f,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=rust,label=org9feda88,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=rust,label=orgec43b43,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=rust,label=org45bab7f,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
