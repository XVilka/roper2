...
\ref{org7ef42a7}), and a mechanism to handle the concurrency plumbing for the
...
\texttt{channels} (\S \ref{orgbc48ae6}). 

\subsection{ROP-chain embryogenesis}
\label{sec:org5b876f7}
\label{org7ef42a7}
...
\lstset{language=rust,label=org14f506a,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=rust,label=orgc08d5e5,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
